...
const EmployeePage = () => {
  ...
  const [employeeUpdateDetails, setEmployeeUpdateDetails] = useState({});
  ...
  const saveDetails = async () => {
    const data = await updateEmployee(id, employeeUpdateDetails);
    setEmployee(data);
    setIsEditing(!isEditing);
  };
        ...
        <div className="p-8">
          <div className="lg:flex lg:items-center lg:justify-between">
            ...
            <div className="min-w-0 flex-1">
              <h2 className="text-2xl font-bold leading-7 text-gray-900 sm:truncate sm:text-3xl sm:tracking-tight">Employee Details</h2>
            </div>
            {isEditing ? (
